...
<data class="col-md-12">
      ...
      <div class="panel-heading">Форма добавления нового ученика</div>
      <div class="panel-body">   
        <form class="form-horizontal" method="post" id="student_add" action="/student_add">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-4 control-label" for="st_active">Активен</label>  
                <div class="col-md-1">
                    <div class="checkbox">
                        <input type="checkbox" id="st_active" name="st_active" value="1" checked>
                    </div>
                </div>
            </div>
            <hr>
            <div class="form-group">
              ...
              <div class="col-md-4">
                <button type="submit" id="btn" class="btn btn-primary btn-block">Добавить ученика</button>
              </div>  
            </div>
          </fieldset>
        </form>
